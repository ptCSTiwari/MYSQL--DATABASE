...
update tiwari set name = 'Aisha Khan' where id = 7;
update tiwari set salary = salary+10000 where salary < 55000;


-- select * from tiwari;
-- SHOW VARIABLES LIKE 'secure_file_priv';
SELECT * 
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/backup.csv'
