...
state varchar(100),
pincode varchar(6),
constraint fk foreign key (user_id) references tiwari(id) on delete cascade
);

insert into adress (user_id, street, city, state, pincode)
values
